...
hunter_config(MadgwickAHRS VERSION 1.2.0-p1)
...
hunter_config(ros VERSION 1.14.4-devel0)
hunter_config(ros_actionlib VERSION 1.11.13-devel0)
hunter_config(ros_common_msgs VERSION 1.12.6-devel0)
hunter_config(ros_comm VERSION 1.13.6-devel1)
hunter_config(ros_comm_msgs VERSION 1.11.2-devel0)
hunter_config(ros_console_bridge VERSION 0.4.0-p0)
hunter_config(ros_environment VERSION 1.2.0-devel0)
...
hunter_config(ros_std_msgs VERSION 0.5.11-devel0)
hunter_config(ros_tf2 VERSION 0.6.2-devel0)
...
hunter_config(ros-geneus VERSION 2.2.6-p1)
hunter_config(ros-genlisp VERSION 0.4.16-p1)
hunter_config(ros-gennodejs VERSION 2.0.1-p1)
hunter_config(ros-genpy VERSION 0.6.7-p1)
hunter_config(ros-message_generation VERSION 0.4.0-p1)
hunter_config(ros-message_runtime VERSION 0.4.12-p1)
hunter_config(ros-std_msgs VERSION 0.5.11-p2)
hunter_config(ros-rospack VERSION 2.4.4-p2)
hunter_config(ros-ros_comm_msgs VERSION 1.11.2-p1)
hunter_config(ros-common_msgs VERSION 1.12.5-p1)
hunter_config(ros-ros VERSION 1.13.6-p1)
