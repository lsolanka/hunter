...
hunter_default_version(CVD VERSION hunter-master-2)
...
hunter_default_version(MRPT VERSION hunter-master-5)
hunter_default_version(MadgwickAHRS VERSION 1.2.0-p1)
...
hunter_default_version(TinyXML VERSION 2.6.2-p1)
...
hunter_default_version(octomap VERSION 1.9.0-ls-p0)
...
hunter_default_version(roboclaw VERSION 0.1.3)
hunter_default_version(rocksdb VERSION 5.8.6)
hunter_default_version(ros VERSION 1.14.4-p0)
hunter_default_version(ros_actionlib VERSION 1.11.13-devel0)
hunter_default_version(ros_angles VERSION 1.9.11-p2)
hunter_default_version(ros_comm VERSION 1.13.6-devel4)
...
hunter_default_version(ros_mrpt_msgs VERSION 0.1.23-p1)
hunter_default_version(ros_std_msgs VERSION 0.5.11-p1)
hunter_default_version(ros_tf VERSION 1.11.9-p3)
hunter_default_version(ros_tf2 VERSION 0.6.2-devel1)
...
## ROS bare bones (early patched kinetic version)
#hunter_default_version(ros-catkin VERSION 0.7.8-p2)
#hunter_default_version(ros-console_bridge VERSION 0.3.2-p2)
#hunter_default_version(ros-roscpp_core VERSION 0.6.7-p1)
#hunter_default_version(ros-genmsg VERSION 0.5.9-p1)
#hunter_default_version(ros-gencpp VERSION 0.5.5-p1)
#hunter_default_version(ros-geneus VERSION 2.2.6-p1)
#hunter_default_version(ros-genlisp VERSION 0.4.16-p1)
#hunter_default_version(ros-gennodejs VERSION 2.0.1-p1)
#hunter_default_version(ros-genpy VERSION 0.6.7-p1)
#hunter_default_version(ros-message_generation VERSION 0.4.0-p1)
#hunter_default_version(ros-message_runtime VERSION 0.4.12-p1)
#hunter_default_version(ros-std_msgs VERSION 0.5.11-p2)
#hunter_default_version(ros-rospack VERSION 2.4.4-p2)
#hunter_default_version(ros-ros_comm_msgs VERSION 1.11.2-p1)
#hunter_default_version(ros-common_msgs VERSION 1.12.5-p1)
#hunter_default_version(ros-ros VERSION 1.13.6-p1)
#hunter_default_version(ros-ros_comm VERSION 1.12.2-p1)
#hunter_default_version(ros-actionlib VERSION 1.11.11-p1)
#hunter_default_version(ros-geometry2 VERSION 0.5.16-p1)
#hunter_default_version(ros-angles VERSION 1.9.11-p1)
